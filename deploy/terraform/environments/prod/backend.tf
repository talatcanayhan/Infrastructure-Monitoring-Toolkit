# =============================================================================
# InfraProbe - Production Remote State Backend
# =============================================================================
...
#        --bucket infraprobe-terraform-state-prod \
#        --region eu-west-1 \
...
#        --table-name infraprobe-terraform-locks-prod \
...
#     region         = "eu-west-1"
#     encrypt        = true
#     dynamodb_table = "infraprobe-terraform-locks-prod"
#   }
# }
